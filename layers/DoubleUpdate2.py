...
class DoubleCell2(LayerRNNCell):
    def __init__(self,
                 num_units,
                 sent_cell: RNNCell,
                 r_cell: RNNCell,
        ...
        super(DoubleCell2, self).__init__(_reuse=reuse, name=name, dtype=dtype, **kwargs)
        ...
        self.sent1 = sent1
        self.sent2 = sent2
        sent_length = self.sent1.get_shape().as_list()[1]
        self.sent1_length = sent_length
        self.sent2_length = sent_length
