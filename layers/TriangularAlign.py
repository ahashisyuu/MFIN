...
class TriangularCell(LayerRNNCell):
    def __init__(self,
        ...
        self._output_size = self.num_units * 3
    ...
    def update_sentence(self, k,
        ...
        # adding TOP K
        m_s2 = self.top_k_att(res_matrix1, s1_tile, k=k, transpose=True)
        m_s1 = self.top_k_att(res_matrix2, s2_tile, k=k, transpose=False)
